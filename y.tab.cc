...
{
       0,    68,    68,    72,    73,    77,    81,    84,    89,    93,
      94,    98,   105,   113,   114,   118,   153,   154,   158,   168,
     178,   189,   200,   210,   222,   225
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "NOTOKEN", "NEWLINE", "GREAT",
  "GREATGREAT", "GREATAMPERSAND", "GREATGREATAMPERSAND", "TWOGREAT",
  "LESS", "AMPERSAND", "PIPE", "$accept", "goal", "command_list",
  "command_line", "pipe_list", "command_and_args", "command_word",
  "argument_list", "argument", "io_modifier_list", "io_modifier",
...
{
       0,     0,    12,     6,     0,     0,     3,    17,    10,    14,
       8,     1,     4,     0,    25,    11,     9,     0,     0,     0,
       0,     0,     0,    24,    16,     7,    15,    13,    18,    19,
      20,    21,    22,    23,     5
};
...
{
      17,    18,    19,    20,    21,    22,    23,    -2,     1,     1,
       2,     2,     3,     3,    10,    11,    13,     2,    34,    26,
...
{
       6,     7,     8,     9,    10,    11,    12,     0,     1,     1,
       3,     3,     5,     5,     5,     0,    13,     3,     5,     3,
       3,     3,     3,     3,     3,     3,    -1,    -1,     5,    -1,
      -1,    -1,    -1,    -1,    -1,    -1,    -1,    13
};
...
static const yytype_int8 yystos[] =
{
       ...
       5,     0,    17,    13,    23,    21,    19,     6,     7,     8,
       9,    10,    11,    12,    24,    25,     3,    22,     3,     3,
       3,     3,     3,     3,     5
};
...
#line 158 "shell.y"
    ...
    if (Shell::_currentCommand._outFile == 0) {
      Shell::_currentCommand._outFile = (yyvsp[0].cpp_string); // 设 file name 置 outFile
...
#line 178 "shell.y"
    ...
    if ((Shell::_currentCommand._outFile == 0) & (Shell::_currentCommand._errFile == 0)) {
      Shell::_currentCommand._outFile = (yyvsp[0].cpp_string);
      Shell::_currentCommand._errFile = new std::string(*(yyvsp[0].cpp_string));
      Shell::_currentCommand._append = false;
    } else {
      printf("Ambiguous output redirect.\n");
    }
